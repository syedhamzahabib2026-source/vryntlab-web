...
export function Process() {
  return (
    <SectionShell id="process" labelledBy="process-heading">
      <div className="flex flex-col gap-9 border-t border-[var(--border)] pt-10 sm:gap-10 sm:pt-11 md:gap-12 md:pt-12 lg:gap-14 lg:pt-14 xl:gap-16 xl:pt-16">
        <Reveal>
          <SectionIntro
            eyebrow="Process"
            ...
            <li key={step.title}>
              <Reveal delay={index * 0.045}>
                <article className={stepCardClass}>
                  ...
                  <h3 className="mt-3 text-[1.0625rem] font-semibold tracking-[-0.02em] text-zinc-950 sm:mt-4 sm:text-lg md:text-xl dark:text-zinc-50">
                    {step.title}
                  </h3>
